...
public class EnglishAlphabetSmallClassifier {

    private static final String LOG_TAG = EnglishAlphabetClassifier.class.getSimpleName();

    private static final String MODEL_NAME = "tf_lite_english_alphabet_small_model.tflite";
    ...
    public EnglishAlphabetSmallClassifier(Activity activity) throws IOException {
