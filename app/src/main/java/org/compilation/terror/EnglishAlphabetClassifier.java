...
public class EnglishAlphabetClassifier {

    private static final String LOG_TAG = EnglishAlphabetClassifier.class.getSimpleName();

    private static final String MODEL_NAME = "tf_lite_english_alphabet_model.tflite";
    ...
    public EnglishAlphabetClassifier(Activity activity) throws IOException {
